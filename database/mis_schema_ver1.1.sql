...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2013 at 05:04 AM
...
CREATE TABLE IF NOT EXISTS `occupant` (
  ...
  `contact_rel1` char(10) DEFAULT NULL COMMENT 'Relationship to the Occupant',
  ...
  `contact_rel2` char(10) DEFAULT NULL COMMENT 'Relationship to the Occupant',
